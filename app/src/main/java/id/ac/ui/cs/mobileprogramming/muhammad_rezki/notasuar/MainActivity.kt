...
import id.ac.ui.cs.mobileprogramming.muhammad_rezki.notasuar.repository.CustomViewModelFactory
import id.ac.ui.cs.mobileprogramming.muhammad_rezki.notasuar.repository.MainViewModel
import id.ac.ui.cs.mobileprogramming.muhammad_rezki.notasuar.ui.main.*
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    inner class ConnectionChangedBroadcastReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            Log.v("CONNECTIVITY","Changed to: "+connectionAvailable().toString())
